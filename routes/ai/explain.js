...
app.post("/personal/explain", async (req, res, next) => {
  try {
    ...
    prompt =
      `A five year old asked me what this passage means and I explained it for them, plain language a second grader can understand:\n###\n` +
    ...
    if (level === "High School") {
      prompt =
        `A college student asked me what this passage means and I rephrased it for them, detailed language that the student can understand:\n###\n` +
